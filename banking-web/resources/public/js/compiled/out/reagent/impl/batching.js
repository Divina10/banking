...
var or__18580__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
var or__18580__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18580__auto____$1)){
return or__18580__auto____$1;
} else {
var or__18580__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18580__auto____$2)){
return or__18580__auto____$2;
} else {
var or__18580__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18580__auto____$3)){
return or__18580__auto____$3;
} else {
...
var n__19483__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__19483__auto__)){
(fs[i]).call(null);
...
var temp__4661__auto___25806 = (this$["componentQueue"]);
if((temp__4661__auto___25806 == null)){
} else {
var cs_25807 = temp__4661__auto___25806;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue.call(null,cs_25807);
}
...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Enqueued function"),cljs.core.str(" must not be nil")].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,new cljs.core.Symbol(null,"f","f",43394975,null)))].join('')));
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__19178__auto__,writer__19179__auto__,opt__19180__auto__){
return cljs.core._write.call(null,writer__19179__auto__,"reagent.impl.batching/RenderQueue");
});
...
//# sourceMappingURL=batching.js.map?rel=1531355029991