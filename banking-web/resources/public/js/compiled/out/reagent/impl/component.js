...
if((i < len)){
var k = (ks[i]);
var G__25721 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__25722 = (i + (1));
m = G__25721;
i = G__25722;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__25726 = c;
var G__25726__$1 = (((G__25726 == null))?null:G__25726.prototype);
if((G__25726__$1 == null)){
return null;
} else {
return (G__25726__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__25730 = c;
var G__25730__$1 = (((G__25730 == null))?null:G__25730.prototype);
if((G__25730__$1 == null)){
return null;
} else {
return (G__25730__$1["render"]);
}
})()));
});
...
var _ = ((cljs.core.ifn_QMARK_.call(null,f))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Expected something callable, not "),cljs.core.str(cljs.core.pr_str.call(null,f))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("clojure.core","ifn?","clojure.core/ifn?",1403867159,null),new cljs.core.Symbol(null,"f","f",43394975,null))))].join('')))})());
...
while (G__25735__i < G__25735__a.length) {G__25735__a[G__25735__i] = arguments[G__25735__i + 0]; ++G__25735__i;}
  args = new cljs.core.IndexedSeq(G__25735__a,0);
} 
...
var _STAR_current_component_STAR_25739 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_25739;
}});
...
var G__25747 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__25747) {
...
var c = this;
var G__25749_25755 = (c["cljsRatom"]);
if((G__25749_25755 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25749_25755);
}
...
var or__18580__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
if((f == null)){
var or__18580__auto____$1 = noargv;
...
if(cljs.core.truth_(reagent.debug.has_console)){
(cljs.core.truth_(reagent.debug.tracking)?reagent.debug.track_console:console).warn([cljs.core.str("Warning: "),cljs.core.str("Exception thrown while comparing argv's in shouldComponentUpdate: "),cljs.core.str(old_argv),cljs.core.str(" "),cljs.core.str(new_argv),cljs.core.str(" "),cljs.core.str(e)].join(''));
} else {
}
...
if(cljs.core.truth_((function (){var and__18568__auto__ = wrap;
...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Expected something callable, not "),cljs.core.str(cljs.core.pr_str.call(null,f))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("clojure.core","ifn?","clojure.core/ifn?",1403867159,null),new cljs.core.Symbol(null,"f","f",43394975,null))))].join('')));
}
} else {
}

var or__18580__auto__ = wrap;
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
return f;
...
if(((1) === cljs.core.count.call(null,renders_25758))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_25759)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Expected something callable, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_25759))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("clojure.core","ifn?","clojure.core/ifn?",1403867159,null),new cljs.core.Symbol(null,"render-fun","render-fun",-1209513086,null))))].join('')));
}


var render_fun = (function (){var or__18580__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
...
var render_fun__$1 = (function (){var or__18580__auto__ = render_fun;
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__18580__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
...
var name__$1 = (function (){var G__25757 = name;
switch (G__25757) {
case "":
...
var G__25762 = o;
(G__25762[cljs.core.name.call(null,k)] = v);
...
return reagent.impl.component.create_react_class.call(null,reagent.impl.component.cljsify.call(null,body));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__25766 = fiber;
var G__25766__$1 = (((G__25766 == null))?null:(G__25766["type"]));
if((G__25766__$1 == null)){
return null;
} else {
return (G__25766__$1["displayName"]);
}
})();
var parent = (function (){var G__25767 = fiber;
if((G__25767 == null)){
return null;
} else {
return (G__25767["return"]);
}
})();
var path = (function (){var G__25768 = parent;
var G__25768__$1 = (((G__25768 == null))?null:reagent$impl$component$fiber_component_path.call(null,G__25768));
if((G__25768__$1 == null)){
return null;
} else {
return [cljs.core.str(G__25768__$1),cljs.core.str(" > ")].join('');
}
})();
...
var temp__4655__auto__ = (function (){var or__18580__auto__ = (function (){var G__25785 = c;
if((G__25785 == null)){
return null;
} else {
return (G__25785["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
...
return G__25786._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__18580__auto__ = (function (){var G__25788 = c;
if((G__25788 == null)){
return null;
} else {
return (G__25788["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
var or__18580__auto____$1 = (function (){var G__25790 = c;
if((G__25790 == null)){
return null;
} else {
return G__25790._reactInternalInstance;
}
})();
...
var elem = (function (){var or__18580__auto__ = (function (){var G__25792 = instance;
if((G__25792 == null)){
return null;
} else {
return (G__25792["_currentElement"]);
}
})();
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
var G__25793 = instance;
if((G__25793 == null)){
return null;
} else {
return G__25793._currentElement;
}
}
})();
var name = (function (){var G__25794 = elem;
var G__25794__$1 = (((G__25794 == null))?null:(G__25794["type"]));
if((G__25794__$1 == null)){
return null;
} else {
return (G__25794__$1["displayName"]);
}
})();
var owner = (function (){var or__18580__auto__ = (function (){var G__25796 = elem;
if((G__25796 == null)){
return null;
} else {
return (G__25796["_owner"]);
}
})();
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
...
return G__25797._owner;
}
}
})();
var path = (function (){var G__25798 = owner;
var G__25798__$1 = (((G__25798 == null))?null:reagent$impl$component$component_path.call(null,G__25798));
if((G__25798__$1 == null)){
return null;
} else {
return [cljs.core.str(G__25798__$1),cljs.core.str(" > ")].join('');
}
})();
var res = [cljs.core.str(path),cljs.core.str(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__18580__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__18580__auto__)){
return or__18580__auto__;
} else {
var G__25800 = c;
var G__25800__$1 = (((G__25800 == null))?null:G__25800.constructor);
if((G__25800__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__25800__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1531355029893