...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19178__auto__,writer__19179__auto__,opt__19180__auto__){
return cljs.core._write.call(null,writer__19179__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__25811 = o;
(G__25811[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25813__i = 0, G__25813__a = new Array(arguments.length -  0);
while (G__25813__i < G__25813__a.length) {G__25813__a[G__25813__i] = arguments[G__25813__i + 0]; ++G__25813__i;}
  args = new cljs.core.IndexedSeq(G__25813__a,0);
} 
return G__25812__delegate.call(this,args);};
G__25812.cljs$lang$maxFixedArity = 0;
G__25812.cljs$lang$applyTo = (function (arglist__25814){
...
var G__25816 = o;
(G__25816[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25818__i < G__25818__a.length) {G__25818__a[G__25818__i] = arguments[G__25818__i + 0]; ++G__25818__i;}
  args = new cljs.core.IndexedSeq(G__25818__a,0);
} 
...
var G__25823 = props;
var G__25823__$1 = (((cljs.core.some_QMARK_.call(null,id)) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null)))?cljs.core.assoc.call(null,G__25823,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25823);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25823__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
return [cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(((reagent.impl.template.named_QMARK_.call(null,old_class))?cljs.core.name.call(null,old_class):old_class))].join('');
}
})());
} else {
return G__25823__$1;
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25824){
var map__25827 = p__25824;
...
var props = map__25827__$1;
var class$ = cljs.core.get.call(null,map__25827__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25827,map__25827__$1,props,class$){
return (function (c){
...
});})(map__25827,map__25827__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_component_set_value;
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25829){
...
var on_write = cljs.core.get.call(null,map__25832__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25832,map__25832__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25832,map__25832__$1,on_write))
);
} else {
...
if(cljs.core.truth_((function (){var and__18568__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18568__auto__){
var and__18568__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__25836 = jsprops;
(G__25836["defaultValue"] = value);

(G__25836["onChange"] = ((function (G__25836,v,value,on_change){
return (function (p1__25834_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25834_SHARP_);
});})(G__25836,v,value,on_change))
);
...
var vec__25841 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25841,(0),null);
var id = cljs.core.nth.call(null,vec__25841,(1),null);
var class$ = cljs.core.nth.call(null,vec__25841,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___25844 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___25844 == null)){
} else {
var key_25845 = temp__4661__auto___25844;
(jsprops["key"] = key_25845);
}
...
var temp__4661__auto___25846 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___25846 == null)){
} else {
var key_25847 = temp__4661__auto___25846;
reagent.impl.template.oset.call(null,jsprops,"key",key_25847);
}

return reagent.impl.template.make_element.call(null,argv,react.Fragment,jsprops,first_child);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__25849 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25849["name"] = c);
...
var len__19638__auto___25855 = arguments.length;
var i__19639__auto___25856 = (0);
while(true){
if((i__19639__auto___25856 < len__19638__auto___25855)){
args__19645__auto__.push((arguments[i__19639__auto___25856]));

var G__25857 = (i__19639__auto___25856 + (1));
i__19639__auto___25856 = G__25857;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19646__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25853){
var G__25854 = cljs.core.first.call(null,seq25853);
var seq25853__$1 = cljs.core.next.call(null,seq25853);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__25854,seq25853__$1);
});
...
break;
default:
var G__25861 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25861;
continue;
...
var n__19483__auto___25864 = a.length;
var i_25865 = (0);
while(true){
if((i_25865 < n__19483__auto___25864)){
(a[i_25865] = reagent.impl.template.as_element.call(null,(a[i_25865])));
...
var a = cljs.core.into_array.call(null,s);
var n__19483__auto___25867 = a.length;
var i_25868 = (0);
while(true){
if((i_25868 < n__19483__auto___25867)){
var val_25869 = (a[i_25868]);
if((cljs.core.vector_QMARK_.call(null,val_25869)) && ((reagent.impl.template.key_from_vec.call(null,val_25869) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25868] = reagent.impl.template.as_element.call(null,val_25869));

var G__25870 = (i_25868 + (1));
i_25868 = G__25870;
continue;
} else {
}
...
var ctx = {};
var vec__25872 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25872,(0),null);
var derefed = cljs.core.nth.call(null,vec__25872,(1),null);
...
var G__25874 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25874) {
case (0):
return react.createElement.call(null,comp,jsprops);

break;
case (1):
return react.createElement.call(null,comp,jsprops,reagent.impl.template.as_element.call(null,cljs.core.nth.call(null,argv,first_child,null)));

break;
default:
return react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25874){
...
//# sourceMappingURL=template.js.map?rel=1531355030140